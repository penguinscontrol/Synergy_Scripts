...
filenames = {'C:\Users\Radu Darie\Google Drive\CSP\Array Data\Array_Q19_20131126.mat';...
     'C:\Users\Radu Darie\Google Drive\CSP\Array Data\Array_Q19_20131124.mat'};
...
for a = 1:length(all)
    all_maxes = zeros(M,1);
    for b = 1:M
        all_maxes(b) = max(all{a}{b});
    end
    
    abs_max = max(all_maxes');
    
    for b = 1:M
        all{a}{b} = all{a}{b}./all_maxes(b).*abs_max;
    end
end